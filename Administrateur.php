...
<link rel="stylesheet" href="STYLES/administrateur.css">

<div class="container" id="container">
	<div class="form-container pic-container">
        <img src="IMAGE/admin1.jpg" alt="" width="500px">
	</div>
	...
	<?php
		...
		if ($_SERVER["REQUEST_METHOD"] === "POST"){
			if (isset($_POST['login']) && isset($_POST['email']) && isset($_POST['password'])) {
				...
				$sql_requete = "select * from utilisateur where Email='$email'  AND ID_role=4";
				...
				if (mysqli_num_rows($res) > 0) {
					...
					setcookie('user', $id, time() + (86400 * 30), "compte.php"); 
...
?>
		...
		<form action="#" method="POST">
			<h1>COMPTE<br>ADMINISTRATEUR</h1>
            <br>
			...
			<button name="login" id="login">Connexion</button>
		</form>
	</div>
</div>
