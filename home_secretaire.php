...
<head>
    ...
    <link rel="stylesheet" href="STYLES/home_secretaie.css">
...
<body>
    <nav class="navbar">
      ...
      <div class="main">
        ...
        <h4>FILIERE GENIE INFORMATIQUE</h4>
                    ...
                    <tr>
                        ...
                        <th>
                          <form action="#" method="POST">
                            <input type="search" required placeholder="Rechercher..." name="search">
                        ...
                        <?php
                              if(isset($_POST['submit'])){
                                $search = $_POST['search'];
                                $sql_requete = "SELECT * FROM rapports_stage
