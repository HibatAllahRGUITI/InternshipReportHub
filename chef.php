...
<div class="container" id="container">
	<div class="form-container pic-container">
        <img src="IMAGE/chefDep2.png" alt="" width="500px">
	</div>
	...
	<?php
		...
		if ($_SERVER["REQUEST_METHOD"] === "POST"){
			if (isset($_POST['login']) && isset($_POST['email']) && isset($_POST['password'])) {
				...
				$sql_requete = "select * from utilisateur where Email='$email'  AND ID_role=2";
				...
				if (mysqli_num_rows($res) > 0) {
					...
					if ($password == $pass) {   
						echo"<script>
							window.location.href = 'home_chef.php';
						</script>	";
						exit();
					} else {
...
?>
		...
		<form action="#" method="POST">
			<h1>COMPTE CHEF <br> DEPARTEMENT</h1>
			<h6>Chef de departements et enseignants</h6>
            <br>
